...
public class GroupDetailsPage extends InterfaceActivity implements View.OnClickListener {

    private static final String TAG = "GroupDetailsPage";
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                // [START_EXCLUDE]
                Toast.makeText(GroupDetailsPage.this, "Failed to load post.",
                        Toast.LENGTH_SHORT).show();
                // [END_EXCLUDE]
            }
        };
        mGroupReference.addValueEventListener(postListener);
    ...
    public void onStop() {
        ...
        if (mPostListener != null) {
            mGroupReference.removeEventListener(mPostListener);
        }
